...
class Rational implements Comparable<Rational>
{
	...
	public boolean equals( Object obj)
	{
		...
		double two = (double) r1.getNumerator() / r1.getDenominator();
		if (one == two)
			return true;
		return false;
	}
	...
	{
		double top = (double) getNumerator() / r1.getDenominator();
		double bottom = (double) r1.getNumerator() / r1.getDenominator();
		if (top == bottom)
			return 0;
		if (top > bottom)
			return 1;
