...
public class Picture extends SimplePicture 
{
  ...
  public void modifyImages() {
	  ...
	  for (Pixel[] rowArray : pixels) {
		  for (Pixel pixelObj : rowArray) {
			  pixelObj.setBlue(2*(pixelObj.getRed() - ave));
			  pixelObj.setBlue(2*(pixelObj.getGreen() - ave));
  ...
  /** Mirror just part of a picture of a snowman */
	...
	public void mirrorPartial(int rowStart, int rowEnd, int colStart, int colEnd, int mirrorPoint, boolean mirrorVertically)
	{
