...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response= "You are talking too much.";
		}
		...
		else if (statement.indexOf("free time") >= 0)
		{
			response = "What do you do during your time off";
		}
		
		else if (statement.indexOf("computer science") >= 0)
		{
			response = "CS is a great tool to learn!";
		}
		
		else if (statement.indexOf("I something you") >= 0)
		{
		...
		{
			response = "What made you get interested in that sport?";
		}
